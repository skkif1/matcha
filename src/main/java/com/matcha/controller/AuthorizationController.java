...
public class AuthorizationController {
    ...
    public @ResponseBody
    String signUp(@RequestBody User user) throws InvalidKeySpecException, NoSuchAlgorithmException {
    ...
    public @ResponseBody
    String loginUser(@RequestBody User user, HttpSession session) throws InvalidKeySpecException, NoSuchAlgorithmException {
    ...
    public @ResponseBody
    String requestOnPasswordReset(@RequestBody User user) {
    ...
    public @ResponseBody
    String newPassword(@RequestParam("password") String password, HttpSession session) {
