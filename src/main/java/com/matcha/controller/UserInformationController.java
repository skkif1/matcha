...
public class UserInformationController {
    ...
    public @ResponseBody
    String changeUserData(@RequestBody User user, HttpSession session) {
    ...
    public @ResponseBody
    String updateUserInfo(@RequestBody UserInformation userinfo, HttpSession session, HttpServletResponse resp) throws IOException {
    ...
    public @ResponseBody
    String updateUserPhoto(@RequestParam("files") MultipartFile[] photos, HttpSession session) {
    ...
    public @ResponseBody
    String deletePhoto(@RequestParam("path") String path, HttpSession session) {
    ...
    public @ResponseBody
    String setAvatar(@RequestParam("path") String path, HttpSession session) {
    ...
    @RequestMapping(value = "/getInfo/{id}", produces = "application/json; charset=UTF-8")
    public @ResponseBody
    String getUserInfo(@PathVariable("id") Integer id, HttpSession session) {
        JsonResponseWrapper json = new JsonResponseWrapper();
