...
public class SearchController {
    ...
    public @ResponseBody
    JsonResponseWrapper searchForUsers(@RequestBody SearchRequest request, HttpSession session) {
    ...
    public @ResponseBody
    JsonResponseWrapper suggestUserProfiles(HttpSession session) {
        JsonResponseWrapper json = new JsonResponseWrapper();
    ...
    public @ResponseBody
    JsonResponseWrapper sortSuggestions(@PathVariable(value = "sortType") String sortType, HttpSession session) {
        JsonResponseWrapper json = new JsonResponseWrapper();
    ...
    public @ResponseBody
    JsonResponseWrapper sortSearched(@PathVariable(value = "sortType") String sortType, HttpSession session) {
        JsonResponseWrapper json = new JsonResponseWrapper();
    ...
    public @ResponseBody
    JsonResponseWrapper sortSuggestions(@RequestBody SearchRequest request, HttpSession session) {
        JsonResponseWrapper json = new JsonResponseWrapper();
