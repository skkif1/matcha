...
!function (e, t) {
    ...
    function M(e, t, n) {
        ...
        if (Z.isEmptyObject(d)) "inline" === ("none" === l ? b(e.nodeName) : l) && (p.display = l); else {
    ...
    var B = [], $ = B.slice, z = B.concat, X = B.push, V = B.indexOf, U = {}, Y = U.toString, G = U.hasOwnProperty,
        K = {}, Q = e.document, J = "2.1.1", Z = function (e, t) {
    ...
    var it = function (e) {
        ...
        function v(e, t, n, i, o, s) {
            return i && !i[_] && (i = v(i)), o && !o[_] && (o = v(o, s)), r(function (r, s, a, u) {
                var l, c, f, d = [], p = [], h = s.length, v = r || g(t || "*", a.nodeType ? [a] : a, []),
                    y = !e || !r && t ? v : m(v, d, e, a, u), x = n ? o || (r ? e : h || i) ? [] : s : y;
                if (n && n(y, x, a, u), i)for (l = m(x, p), i(l, [], a, u), c = l.length; c--;)(f = l[c]) && (x[p[c]] = !(y[p[c]] = f));
                if (r) {
                    if (o || e) {
                        if (o) {
        ...
        function x(e, n) {
            var i = n.length > 0, o = e.length > 0, s = function (r, s, a, u, l) {
                var c, f, d, p = 0, h = "0", g = r && [], v = [], y = D, x = r || o && T.find.TAG("*", l),
        ...
        var b, w, T, C, k, N, E, S, D, j, A, L, M, H, O, q, P, R, F, _ = "sizzle" + -new Date, I = e.document, W = 0,
            B = 0, $ = n(), z = n(), X = n(), V = function (e, t) {
                return e === t && (A = !0), 0
            }, U = "undefined", Y = 1 << 31, G = {}.hasOwnProperty, K = [], Q = K.pop, J = K.push, Z = K.push, et = K.slice,
            ...
            ft = new RegExp("=" + rt + "*([^\\]'\"]*?)" + rt + "*\\]", "g"), dt = new RegExp(at),
            pt = new RegExp("^" + ot + "$"), ht = {
                ID: new RegExp("^#(" + it + ")"),
                CLASS: new RegExp("^\\.(" + it + ")"),
                    ...
                    return 1 === r && 0 === i ? function (e) {
                        ...
                        if (m) {
                            ...
                            if (h = [s ? m.firstChild : m.lastChild], s && y) {
                                for (c = m[_] || (m[_] = {}), l = c[e] || [], p = l[0] === W && l[1], d = l[0] === W && l[2], f = p && m.childNodes[p]; f = ++p && f && f[g] || (d = p = 0) || h.pop();)if (1 === f.nodeType && ++d && f === t) {
                                    c[e] = [W, p, d];
                                    break
                                }
                            } else if (y && (l = (t[_] || (t[_] = {}))[e]) && l[0] === W) d = l[1]; else for (; (f = ++p && f && f[g] || (d = p = 0) || h.pop()) && ((a ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++d || (y && ((f[_] || (f[_] = {}))[e] = [W, d]), f !== t)););
    ...
    var ut, lt = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/, ct = Z.fn.init = function (e, t) {
        ...
        if ("string" == typeof e) {
            ...
            if (n[1]) {
                if (t = t instanceof Z ? t[0] : t, Z.merge(this, Z.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t : Q, !0)), st.test(n[1]) && Z.isPlainObject(t))for (n in t)Z.isFunction(this[n]) ? this[n](t[n]) : this.attr(n, t[n]);
                return this
            }
    ...
    Z.Callbacks = function (e) {
        ...
        Deferred: function (e) {
            ...
            var t, n, r, i = 0, o = $.call(arguments), s = o.length,
    ...
    Z.event = {
        ...
        trigger: function (t, n, r, i) {
            var o, s, a, u, l, c, f, d = [r || Q], p = G.call(t, "type") ? t.type : t,
        ...
        dispatch: function (e) {
            e = Z.event.fix(e);
            var t, n, r, i, o, s = [], a = $.call(arguments), u = (vt.get(this, "events") || {})[e.type] || [],
    ...
    var At = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, Lt = /<([\w:]+)/,
        Mt = /<|&#?\w+;/, Ht = /<(?:script|style|link)/i, Ot = /checked\s*(?:[^=]|=\s*.checked.)/i,
        qt = /^$|\/(?:java|ecma)script/i, Pt = /^true\/(.*)/, Rt = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, Ft = {
    ...
    Ft.optgroup = Ft.option, Ft.tbody = Ft.tfoot = Ft.colgroup = Ft.caption = Ft.thead, Ft.th = Ft.td, Z.extend({
        clone: function (e, t, n) {
            ...
            if (!(K.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || Z.isXMLDoc(e)))for (s = v(a), o = v(e), r = 0, i = o.length; i > r; r++)y(o[r], s[r]);
            ...
            for (var i, o, s, a, u, l, c = t.createDocumentFragment(), f = [], d = 0, p = e.length; p > d; d++)if (i = e[d], i || 0 === i)if ("object" === Z.type(i)) Z.merge(f, i.nodeType ? [i] : i); else if (Mt.test(i)) {
            ...
            for (c.textContent = "", d = 0; i = f[d++];)if ((!r || -1 === Z.inArray(i, r)) && (u = Z.contains(i.ownerDocument, i), o = v(c.appendChild(i), "script"), u && g(o), n))for (l = 0; i = o[l++];)qt.test(i.type || "") && n.push(i);
            return c
        ...
        text: function (e) {
            ...
            if (l && (n = Z.buildFragment(e, this[0].ownerDocument, !1, this), r = n.firstChild, 1 === n.childNodes.length && (n = r), r)) {
                ...
                if (o)for (a = i[i.length - 1].ownerDocument, Z.map(i, h), u = 0; o > u; u++)s = i[u], qt.test(s.type || "") && !vt.access(s, "globalEval") && Z.contains(a, s) && (s.src ? Z._evalUrl && Z._evalUrl(s.src) : Z.globalEval(s.textContent.replace(Rt, "")))
            }
            return this
        }
    }), Z.each({
    ...
    var _t, It = {}, Wt = /^margin/, Bt = new RegExp("^(" + wt + ")(?!px)[a-z%]+$", "i"), $t = function (e) {
    ...
    var Kt, Qt, Jt = /^(?:toggle|show|hide)$/, Zt = new RegExp("^(?:([+-])=|)(" + wt + ")([a-z%]*)$", "i"),
        en = /queueHooks$/, tn = [M], nn = {
            "*": [function (e, t) {
    ...
    Z.fn.extend({
        ...
        valHooks: {
            option: {
                ...
                get: function (e) {
                    for (var t, n, r = e.options, i = e.selectedIndex, o = "select-one" === e.type || 0 > i, s = o ? null : [], a = o ? i + 1 : r.length, u = 0 > i ? a : o ? i : 0; a > u; u++)if (n = r[u], !(!n.selected && u !== i || (K.optDisabled ? n.disabled : null !== n.getAttribute("disabled")) || n.parentNode.disabled && Z.nodeName(n.parentNode, "optgroup"))) {
    ...
    var An = 0, Ln = {}, Mn = {0: 200, 1223: 204}, Hn = Z.ajaxSettings.xhr();
    e.ActiveXObject && Z(e).on("unload", function () {
        ...
        return K.cors || Hn && !e.crossDomain ? {
            send: function (n, r) {
                ...
                t = function (e) {
                    return function () {
                        t && (delete Ln[s], t = o.onload = o.onerror = null, "abort" === e ? o.abort() : "error" === e ? r(o.status, o.statusText) : r(Mn[o.status] || o.status, o.statusText, "string" == typeof o.responseText ? {text: o.responseText} : void 0, o.getAllResponseHeaders()))
                    }
    ...
    Z.ajaxSetup({
        ...
        var i, o, s,
            a = t.jsonp !== !1 && (qn.test(t.url) ? "url" : "string" == typeof t.data && !(t.contentType || "").indexOf("application/x-www-form-urlencoded") && qn.test(t.data) && "data");
    ...
    var s = /\+/g, a = e.cookie = function (i, s, u) {
    ...
    var o,
        ...
        }, f = {"byte": {floor: !0, max: 255}, percent: {max: 1}, degrees: {mod: 360, floor: !0}}, d = l.support = {},
        p = e("<p>")[0], h = e.each;
    p.style.cssText = "background-color:rgba(1,1,1,.5)", d.rgba = p.style.backgroundColor.indexOf("rgba") > -1, h(c, function (e, t) {
        ...
        parse: function (i, s, a, u) {
            ...
            var f = this, d = e.type(i), p = this._rgba = [];
            ...
            var r = l(e), i = r._space(), o = c[i], s = 0 === this.alpha() ? l("transparent") : this,
                a = s[o.cache] || o.to(s._rgba), u = a.slice();
            return r = r[o.cache], h(o.props, function (e, i) {
                var o = i.idx, s = a[o], l = r[o], c = f[i.type] || {};
        ...
        var t, n, r = e[0] / 255, i = e[1] / 255, o = e[2] / 255, s = e[3], a = Math.max(r, i, o),
            u = Math.min(r, i, o), l = a - u, c = a + u, f = .5 * c;
        ...
        l.fn[r] = function (r) {
            ...
            var i, a = e.type(r), f = "array" === a || "object" === a ? r : arguments, d = this[s].slice();
    ...
    function t(t) {
        var s = t || window.event, a = u.call(arguments, 1), l = 0, f = 0, d = 0, p = 0, h = 0, g = 0;
    ...
    e.browserTest = function (t, n) {
        var r = "unknown", i = "X", o = function (e, t) {
            for (var n = 0; n < t.length; n += 1)e = e.replace(t[n][0], t[n][1]);
            return e
        }, s = function (t, n, s, a) {
            var u = {name: o((n.exec(t) || [r, r])[1], s)};
    ...
    var e = window.AudioContext || window.webkitAudioContext, t = {
        ...
        sound: function (e, n) {
            function r(e) {
                for (var t = [], n = e.length - 1, r = 0; n >= r; r++)t.push({start: e.start(r), end: e.end(r)});
                return t
            }
            ...
            n = n || {};
            var s = n.document || t.defaults.document, a = 0, u = [], l = {}, c = t.isSupported();
            if (this.load = function () {
                    ...
                    for (var n = this, r = function (e) {
                        ...
                        var o = e[i], s = o;
                        o = s.split(".")[0], u.push({idx: s, func: r}), this.sound.addEventListener(o, r, !0)
                    }
                    return this
                }, this.unbind = function (e) {
                    if (!c)return this;
                    e = e.split(" ");
                    for (var t = 0; t < e.length; t++)for (var n = e[t], r = n.split(".")[0], i = 0; i < u.length; i++) {
                        var o = u[i].idx.split(".");
                    ...
                    if (!c)return this;
                    e = e.split(" ");
                    for (var t = 0; t < e.length; t++)for (var n = e[t], r = 0; r < u.length; r++) {
                        var i = u[r].idx.split(".");
                    ...
                    var o = this.volume, s = n / Math.abs(o - e), a = this;
                ...
                if (this.sound = s.createElement("audio"), t.audioCtx && (this.source = t.audioCtx.createMediaElementSource(this.sound), this.source.connect(t.audioCtx.destination)), e instanceof Array)for (var d in e)e.hasOwnProperty(d) && o(this.sound, e[d]); else if (n.formats.length)for (var p in n.formats)n.formats.hasOwnProperty(p) && o(this.sound, e + "." + n.formats[p]); else o(this.sound, e);
